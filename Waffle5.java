...
public class Waffle5 extends JFrame {
	...
	public Waffle5() {
		...
		large_Choco.setBounds(551, 188, 207, 93);
		...
		lblNewLabel_2.setBounds(220, 564, 104, 91);
		contentPane.add(lblNewLabel_2);
		
		JLabel lblNewLabel_3 = new JLabel("New label");
		lblNewLabel_3.setIcon(new ImageIcon("C:\\Users\\User\\Desktop\\TNI107\\chinese-mandarin-1 (1) (1).png"));
		lblNewLabel_3.setBounds(250, 133, 54, 40);
		contentPane.add(lblNewLabel_3);
		
		JLabel lblNewLabel_4 = new JLabel("New label");
		lblNewLabel_4.setIcon(new ImageIcon("C:\\Users\\User\\Desktop\\TNI107\\วิตามินซี-สตรอเบอร์รี่ (1) (1).png"));
		lblNewLabel_4.setBounds(220, 204, 84, 57);
		contentPane.add(lblNewLabel_4);
		
		JLabel lblNewLabel_5 = new JLabel("New label");
		lblNewLabel_5.setIcon(new ImageIcon("C:\\Users\\User\\Desktop\\TNI107\\ชาเขียวมัทฉะ-300x180_(1)-transformed.png"));
		lblNewLabel_5.setBounds(759, 126, 102, 55);
		contentPane.add(lblNewLabel_5);
		
		JLabel lblNewLabel_6 = new JLabel("New label");
		lblNewLabel_6.setIcon(new ImageIcon("C:\\Users\\User\\Desktop\\TNI107\\iStock_000016088140_Small-600x387_(1)-transformed.png"));
		lblNewLabel_6.setBounds(759, 201, 109, 63);
